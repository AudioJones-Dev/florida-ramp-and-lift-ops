...
export const mockLeads: Lead[] = [
  ...
  },
  {
    ...
    contactName: "Example Modular Services account",
  ...
  },
  {
    ...
    contactName: "Example Modular Services coordinator",
...
export const mockCustomers: Customer[] = [
  ...
  },
  {
    ...
    displayName: "Example Modular Services account",
    status: "active",
  ...
  },
  {
    ...
    customerId: "customer_005",
    customerType: "commercial",
    displayName: "Example Modular Services Call Demo",
    status: "active",
    primaryContactName: "Example Modular Services coordinator",
    primaryContactPhone: "(555) 013-0105",
    primaryContactEmail: "modular.services.demo@example.com",
    source: "Demo Scenario 2",
...
export const mockJobs: Job[] = [
  ...
  },
  {
    ...
    jobNumber: "FLR-1048",
    customerId: "customer_002",
    customerName: "Example Modular Services account",
  ...
  },
  {
    ...
    jobNumber: "FLR-2002",
    customerId: "customer_005",
    customerName: "Example Modular Services Call Demo",
    jobType: "Commercial modular-site service call",
    status: "in_progress",
...
export const mockContractors: Contractor[] = [
  ...
  },
  {
    ...
    skills: ["Ramp takedown", "Commercial modular-site work"],
    vehicleAccess: "Yes",
    toolAccess: "Yes",
...
export const mockCommunications: Communication[] = [
  ...
  },
  {
    ...
    summary: "Example Modular Services requested service-call closeout confirmation.",
    followUpOwner: "Office Admin"
  },
  {
...
export const mockDocumentation: DocumentationArtifact[] = [
  ...
  },
  {
    ...
    source: "Demo Scenario 2",
    reviewGate: "Needs review",
    notes: "Closeout notes submitted for the Example Modular Services call."
  },
  {
...
export const mockAlerts: Alert[] = [
  ...
  },
  {
    ...
    status: "open",
    owner: "Office Admin",
    summary: "Example Modular Services closeout needs review.",
...
export const mockApprovals: Approval[] = [
  ...
  },
  {
    ...
    targetTransition: "Documentation submitted -> approved",
    evidenceSummary: "Example Modular Services notes submitted and awaiting review.",
...
export const mockContractorAssignments: ContractorAssignment[] = [
  ...
  },
  {
    ...
    jobId: "job_002",
    jobNumber: "FLR-1048",
    jobTitle: "Example Modular Services takedown",
  ...
  },
  {
    ...
    jobId: "job_005",
    jobNumber: "FLR-2002",
    jobTitle: "Example Modular Services call",
    contractorName: "Senior Lead B",
    location: "Commercial site, Lakeland area",
    siteContact: "Example Modular Services coordinator",
...
export const demoScenarios: DemoScenario[] = [
  ...
  {
    id: "scenario_002",
    title: "Example Modular Services Call",
